...
CREATE TABLE IF NOT EXISTS venue_activity_rules (
  ...
  cycle_type VARCHAR(16) NOT NULL DEFAULT 'weekly' COMMENT 'daily | weekly | monthly | yearly | range | datetime_range | repeat',
  cycle_values JSON DEFAULT NULL COMMENT 'legacy数组或range日期；datetime_range/repeat使用startDate/startTime/endDate/endTime，repeat另含intervalUnit/intervalValue/repeatCount',
  time_start TIME NOT NULL DEFAULT '09:00:00',
  time_end TIME NOT NULL DEFAULT '18:00:00',
  is_active TINYINT(1) NOT NULL DEFAULT 1,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
