...
mysql -u !DB_USER! -p!DB_PASS! -h !DB_HOST! -P !DB_PORT! !DB_NAME! -e "INSERT INTO admin_info (id, name, student_id, admin_level, bind_status, invite_code, invited_at) VALUES (REPLACE(UUID(), '-', ''), '!ESC_NAME!', '!ESC_STUDENT!', 'root_admin', 'invited', '!ESC_INVITE!', UTC_TIMESTAMP());" 2>&1
if !ERRORLEVEL! NEQ 0 (
    endlocal
