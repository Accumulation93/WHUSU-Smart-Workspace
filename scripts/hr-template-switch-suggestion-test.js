...
assert.equal(buildSwitchSources([Object.assign({}, sources[0], { type: 'text' })], [target], '', String)[0].action, 'map');
assert.equal(buildSwitchSources([Object.assign({}, sources[0], { suggestedDefault: false })], [target], '', String)[0].action, 'map');
assert.equal(buildSwitchSources([Object.assign({}, sources[0], { suggestedDefault: undefined })], [target], '', String)[0].action, 'map');
